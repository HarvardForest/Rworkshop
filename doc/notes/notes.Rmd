...
Often data will have quality issues. There can be typos, misclassifications, and missing data.

Not sure exactly what you want here Matt

* summary(),hist(),table(), is.na(), complete.cases()

## 3. [Prep the data]
REUdata$PiratesNinjas <- 
