...
<!-- Luca: finish up -->
<!-- - Talk about exploring data and why to double check -->
<!-- - Cover column selection  -->

Often data will have quality issues. There can be typos,
misclassifications, and missing data.

* summary(),hist(),table(), is.na(), complete.cases(), names()
...
<!-- Luca: finish example writing vector -->

```{r , eval=FALSE,echo=FALSE}

pirates.or.ninjas <- c('p','n','p',NA,)

## append with x[,'pirate.ninja']

```

##Activity: play around with plots!

<!-- Luca: change the text to match working with the cleaned pirates.ninjas -->
<!-- and give them a group of functions to use -->

With a set of data, figure out a way to visualize the mean of that
data. This will challenge you to use the resources and tools that
you've learned today, and is also very similar to the way you'll have
to use R in the future. You have an end goal in mind, but you need to
do some searching and experimentation to figure out how best to
achieve it!
